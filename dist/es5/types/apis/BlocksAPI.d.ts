...
export interface BlocksAPI {
    ...
    getFee(callback?: cback<{
        fee: number;
    }>): Promise<{
        fee: number;
    } & BaseApiResponse>;
    getReward(callback?: cback<{
        reward: number;
    }>): Promise<{
        reward: number;
    } & BaseApiResponse>;
    getSupply(callback?: cback<{
        supply: number;
    }>): Promise<{
        supply: number;
    } & BaseApiResponse>;
    ...
    getNethash(callback?: cback<{
        nethash: string;
    }>): Promise<{
        nethash: string;
    } & BaseApiResponse>;
    getMilestone(callback?: cback<{
        milestone: number;
    }>): Promise<{
        milestone: number;
    } & BaseApiResponse>;
    getBlock(id: string, callback?: cback<{
        block: Block;
    }>): Promise<{
        block: Block;
    } & BaseApiResponse>;
