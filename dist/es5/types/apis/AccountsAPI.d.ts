...
export interface AccountsAPI {
     ...
     */
    open(secret: string, callback?: cback<{
        account: Account;
    }>): Promise<{
        account: Account;
    } & BaseApiResponse>;
     ...
     * @param callback callback where to receive the result.
     */
    getBalance(address: string, callback?: cback<{
        balance: string;
     ...
     * @param callback callback where to receive the result.
     */
    getPublicKey(address: string, callback?: cback<{
        publicKey: string;
    }>): Promise<{
        publicKey: string;
    } & BaseApiResponse>;
     ...
     * @param callback callback where to receive the result.
     */
    generatePublicKey(secret: string, callback?: cback<{
        publicKey: string;
    }>): Promise<{
        publicKey: string;
    } & BaseApiResponse>;
     ...
     * @param callback callback where to receive the result.
     */
    getAccount(address: string, callback?: cback<{
        account: Account;
    }>): Promise<{
        account: Account;
    } & BaseApiResponse>;
     ...
     * @param callback callback where to receive the result.
     */
    getAccountByPublicKey(publicKey: string, callback?: cback<{
        account: Account;
    }>): Promise<{
        account: Account;
    } & BaseApiResponse>;
     ...
     * @param callback callback where to receive the result.
     */
    getDelegates(address: string, callback?: cback<{
        delegates: Delegate[];
    }>): Promise<{
        delegates: Delegate[];
    } & BaseApiResponse>;
    ...
    putDelegates(data: {
        ...
        delegates: string[];
        secondSecret?: string;
    }, callback?: cback<any>): Promise<any>;
}
